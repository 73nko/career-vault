# AGENTS.md — Career Vault

This is an Obsidian knowledge vault, not a code repository. Most rules in
`~/.Codex/AGENTS.md` are written for software engineering work and do not
...
- **Templates live in [`99_Templates/`](99_Templates/)** and use Templater
  syntax: `2026-05-21`, `AGENTS`. When you
...
## What does NOT apply from the global `~/.Codex/AGENTS.md`
...
- When code is involved, the global `~/.Codex/AGENTS.md` engineering rules
  *do* apply — TDD, surgical changes, etc.

## Slash commands

Project-scoped slash commands live in `.Codex/commands/` at the vault root.
...
This vault has its own Codex memory directory. The user's profile (Staff
